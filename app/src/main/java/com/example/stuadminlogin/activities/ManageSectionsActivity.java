...
public class ManageSectionsActivity extends AppCompatActivity {
    ...
    private SectionListAdapter adapter;
    private int classId;
    // Removed: private TextView textHeader; // No longer needed, title is on Toolbar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            if (className != null && !className.isEmpty()) {
                getSupportActionBar().setTitle("Sections for " + className);
            } else {
                getSupportActionBar().setTitle("Sections (Class ID: " + classId + ")");
            }
        ...
        btnAdd = findViewById(R.id.btnAddSection);
        btnSearch = findViewById(R.id.btnSearchSection);
        // Removed: textHeader = findViewById(R.id.textViewSelectedClass); // No longer needed
        textNoData = findViewById(R.id.textNoSectionsFound);

        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        // Removed: textHeader.setText("Sections for " + (className != null ? className : ("Class ID: " + classId))); // Handled by Toolbar
    ...
    private void showSectionDialog(SectionModel editModel) {
        ...
        if (editModel != null) {
            ...
            dialogTitle.setText("Add Section"); // Ensure title is set for add mode too
        }
    ...
    private void showSearchDialog() {
        ...
        View dialogView = LayoutInflater.from(this).inflate(R.layout.dialog_filter_section, null);
        builder.setView(dialogView);
        builder.setTitle("Search Sections"); // This is fine for AlertDialog title
    ...
    private void loadSections(String nameFilter) {
        ...
        String query = "SELECT section_id, section_name, class_id FROM sections WHERE class_id=?"; // Specify columns
        List<String> args = new ArrayList<>();
        args.add(String.valueOf(classId));
        ...
        while (cursor.moveToNext()) {
            sectionList.add(new SectionModel(
                cursor.getInt(cursor.getColumnIndexOrThrow("section_id")),
