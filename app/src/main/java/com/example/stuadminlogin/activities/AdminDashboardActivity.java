...
public class AdminDashboardActivity extends Activity {
    ...
    Button issueNoticeBtn, viewAllQueriesBtn, viewParentQueriesBtn; // Added viewParentQueriesBtn
    Button manageAdminsBtn, manageLeaveBtn, manageClassesBtn, btnManageHolidays, btnViewHolidays, btnViewProfile, btnLogout;
    Button btnManageGroups;
    TextView welcomeText;
    int currentAdminId;
    DatabaseHelper dbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        issueNoticeBtn = findViewById(R.id.issueNoticeButton);
        viewAllQueriesBtn = findViewById(R.id.btn_view_all_queries);
        viewParentQueriesBtn = findViewById(R.id.btn_view_parent_queries); // Initialize the new button
        manageAdminsBtn = findViewById(R.id.btn_manage_admins);
        manageLeaveBtn = findViewById(R.id.btn_manage_leaves);
        manageClassesBtn = findViewById(R.id.btn_manage_classes);
        btnManageHolidays = findViewById(R.id.btnManageHolidays);
        ...
        // Listener for Student Queries (now explicitly only students, or all if you prefer)
        viewAllQueriesBtn.setOnClickListener(v -> {
            Intent intent = new Intent(this, AdminViewQueriesActivity.class); // This one still shows combined or just student
            intent.putExtra("admin_id", currentAdminId);
            startActivity(intent);
        });

        // NEW Listener for Parent Queries: Launch AdminViewParentQueriesActivity
        viewParentQueriesBtn.setOnClickListener(v -> {
            Intent intent = new Intent(this, AdminViewParentQueriesActivity.class); // Launch the NEW activity
            intent.putExtra("admin_id", currentAdminId);
            startActivity(intent);
        });
